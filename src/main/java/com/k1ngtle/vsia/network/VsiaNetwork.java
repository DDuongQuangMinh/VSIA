...
public class VsiaNetwork {
    ...
    public static void register() {
        ...
        net.messageBuilder(
                        WifiIpEngineeringRequestPacket.class,
                        id(),
                        NetworkDirection.PLAY_TO_SERVER
                )
                .decoder(WifiIpEngineeringRequestPacket::new)
                .encoder(WifiIpEngineeringRequestPacket::toBytes)
                .consumerMainThread(WifiIpEngineeringRequestPacket::handle)
                .add();

        net.messageBuilder(
                        WifiIpEngineeringActionPacket.class,
                        id(),
                        NetworkDirection.PLAY_TO_SERVER
                )
                .decoder(WifiIpEngineeringActionPacket::new)
                .encoder(WifiIpEngineeringActionPacket::toBytes)
                .consumerMainThread(WifiIpEngineeringActionPacket::handle)
                .add();

        net.messageBuilder(
                        WifiIpEngineeringSnapshotPacket.class,
                        id(),
                        NetworkDirection.PLAY_TO_CLIENT
                )
        ...
        net.messageBuilder(
                        WifiMultiEngineeringOpenPacket.class,
                        id(),
                        NetworkDirection.PLAY_TO_CLIENT
                )
                .decoder(WifiMultiEngineeringOpenPacket::new)
                .encoder(WifiMultiEngineeringOpenPacket::toBytes)
                .consumerMainThread(WifiMultiEngineeringOpenPacket::handle)
                .add();

        net.messageBuilder(
                        W128IdeRequestPacket.class,
                        id(),
                        NetworkDirection.PLAY_TO_SERVER
                )
                .decoder(W128IdeRequestPacket::new)
                .encoder(W128IdeRequestPacket::toBytes)
                .consumerMainThread(W128IdeRequestPacket::handle)
                .add();

        net.messageBuilder(
                        W128IdeSnapshotPacket.class,
                        id(),
                        NetworkDirection.PLAY_TO_CLIENT
                )
