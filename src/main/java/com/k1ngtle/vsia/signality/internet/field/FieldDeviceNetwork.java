...
public final class FieldDeviceNetwork {
    ...
    public static synchronized void register() {
        ...
        channel.messageBuilder(
                ...
                .decoder(
                        C2SRadioGuiRequestPacket::new
                )
                .encoder(
                        C2SRadioGuiRequestPacket::toBytes
                )
                .consumerMainThread(
                        C2SRadioGuiRequestPacket::handle
                )
                .add();
        ...
        channel.messageBuilder(
                ...
                .decoder(
                        C2SRadioGuiActionPacket::new
                )
                .encoder(
                        C2SRadioGuiActionPacket::toBytes
                )
                .consumerMainThread(
                        C2SRadioGuiActionPacket::handle
                )
                .add();
        ...
        channel.messageBuilder(
                ...
                .decoder(
                        S2CRadioGuiSnapshotPacket::new
                )
                .encoder(
                        S2CRadioGuiSnapshotPacket::toBytes
                )
                .consumerMainThread(
        ...
        channel.messageBuilder(
                ...
                .decoder(
                        C2SSatelliteGuiRequestPacket::new
                )
                .encoder(
                        C2SSatelliteGuiRequestPacket::toBytes
                )
                .consumerMainThread(
                        C2SSatelliteGuiRequestPacket::handle
                )
                .add();
        ...
        channel.messageBuilder(
                ...
                .decoder(
                        C2SSatelliteGuiActionPacket::new
                )
                .encoder(
                        C2SSatelliteGuiActionPacket::toBytes
                )
                .consumerMainThread(
                        C2SSatelliteGuiActionPacket::handle
                )
                .add();
        ...
        channel.messageBuilder(
                ...
                .decoder(
                        S2CSatelliteGuiSnapshotPacket::new
                )
                .encoder(
                        S2CSatelliteGuiSnapshotPacket::toBytes
                )
                .consumerMainThread(
